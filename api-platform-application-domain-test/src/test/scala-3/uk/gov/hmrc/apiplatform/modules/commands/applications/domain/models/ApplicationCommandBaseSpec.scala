...
trait ApplicationCommandBaseSpec extends HmrcSpec with FixedClock {
  ...
  val newPrivacyPolicyLocation = PrivacyPolicyLocation.InDesktopSoftware
  val newTandCLocation         = TermsAndConditionsLocation.InDesktopSoftware
  ...
  val redirectUri         = LoginRedirectUri.unsafeApply("https://someurl.com/path/to/glory")
  val redirectUriToChange = LoginRedirectUri.unsafeApply("https://oldUrl/that/needs/a/change")
