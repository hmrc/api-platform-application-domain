...
class ApiFieldMapSpec
  ...
  "read from BulkSubscriptionFieldsResponse json" in {
    given Writes[SubscriptionFieldsId]           = Json.valueWrites[SubscriptionFieldsId]
    given Writes[SubscriptionFields]             = Json.writes[SubscriptionFields]
    given Writes[BulkSubscriptionFieldsResponse] = Json.writes[BulkSubscriptionFieldsResponse]
