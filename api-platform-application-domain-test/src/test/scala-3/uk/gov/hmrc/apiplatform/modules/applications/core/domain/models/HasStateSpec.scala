...
class HasStateSpec extends HmrcSpec with Matchers with FixedClock {
  ...
  val allStates: Set[State] =
    Set(
      ...
      State.PendingResponsibleIndividualVerification,
      State.PreProduction,
      State.Production,
      State.Deleted
    )
  ...
  "HasState" should {
    "respond to isApproved" in {
      val trueValues  = Set(State.Production, State.PreProduction)
    ...
    "respond to isDeleted" in {
      val trueValues  = List(State.Deleted)
      val falseValues = allStates -- trueValues
    ...
    "respond to isInPendingGatekeeperApprovalOrResponsibleIndividualVerification" in {
      val trueValues  = List(State.PendingGatekeeperApproval, State.PendingResponsibleIndividualVerification)
      val falseValues = allStates -- trueValues
    ...
    "respond to isInPreProduction" in {
      val trueValues  = List(State.PreProduction)
      val falseValues = allStates -- trueValues
    ...
    "respond to isInProduction" in {
      val trueValues  = List(State.Production)
      val falseValues = allStates -- trueValues
    ...
    "respond to isInTesting" in {
      val trueValues  = List(State.Testing)
      val falseValues = allStates -- trueValues
    ...
    "respond to isPendingGatekeeperApproval" in {
      val trueValues  = List(State.PendingGatekeeperApproval)
      val falseValues = allStates -- trueValues
    ...
    "respond to isPendingRequesterVerification" in {
      val trueValues  = List(State.PendingRequesterVerification)
      val falseValues = allStates -- trueValues
    ...
    "respond to isPendingResponsibleIndividualVerification" in {
      val trueValues  = List(State.PendingResponsibleIndividualVerification)
      val falseValues = allStates -- trueValues
