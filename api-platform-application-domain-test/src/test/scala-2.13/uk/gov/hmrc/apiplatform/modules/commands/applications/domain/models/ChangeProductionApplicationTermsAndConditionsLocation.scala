...
class ChangeProductionApplicationTermsAndConditionsLocationSpec extends ApplicationCommandBaseSpec {
  ...
  "ChangeProductionApplicationTermsAndConditionsLocation" should {
    ...
    "read from json" in {
      val jsonText =
        s""" {"instigator":"$aUserId","timestamp":"$nowAsText","newLocation":{"termsAndConditionsType":"inDesktop"},"updateType":"changeProductionApplicationTermsAndConditionsLocation"} """
