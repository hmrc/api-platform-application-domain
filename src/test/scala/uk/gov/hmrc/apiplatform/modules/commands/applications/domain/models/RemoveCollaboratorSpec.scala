...
class RemoveCollaboratorSpec extends ApplicationCommandBaseSpec {
  ...
  "RemoveCollaborator" should {
    ...
    "read from json" in {
      val jsonText =
        s""" {"actor":{"email":"bob@example.com","actorType":"COLLABORATOR"},"collaborator":{"emailAddress":"alice@example.com","role":"DEVELOPER","userId":"$aUserId"},"timestamp":"$nowAsText","updateType":"removeCollaborator"} """
